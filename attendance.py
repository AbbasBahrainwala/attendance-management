...
attendance_path = "Attendance-Management-system-using-face-recognition-master\\Attendance"
...
logo = Image.open(r"Attendance-Management-system-using-face-recognition-master\\UI_Image\\0001.png")
...
ri = Image.open(r"Attendance-Management-system-using-face-recognition-master\\UI_Image\\register.png")
r = ImageTk.PhotoImage(ri)
label1 = Label(window, image=r)
label1.image = r
label1.place(x=100, y=270)

ai = Image.open(r"Attendance-Management-system-using-face-recognition-master\\UI_Image\\attendance.png")
a = ImageTk.PhotoImage(ai)
label2 = Label(window, image=a)
label2.image = a
label2.place(x=980, y=270)

vi = Image.open(r"Attendance-Management-system-using-face-recognition-master\\UI_Image\\verifyy.png")
